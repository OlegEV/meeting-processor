...
#### Вариант 1: Встроенная запись (если доступно)
...
### 🔴 KTalk - Встроенная запись (если вы организатор)
...
1. File -> Settings -> General
   - В выпадающем списке "Language" выберите "Русский"
   - Нажмите "ОК"
   - Перезагрузите приложение

2. Файл -> Настройки -> Вывод
   - В выпадающем списке "Режим вывода" выберите "Расширенный"
   - Перейдите на вкладку "Запись"
   - В выпадающем списке "Тип" выберите "Пользовательский вывод (FFmpeg)"
   - В выпадающем списке "Формат контейнера" выберите "mp3"
   - В выпадающем списке "Кодировщик видео" выберите "Отключить кодировщик"

3. Файл -> Настройки -> Аудио
   - Частота дискретизации: 48 kHz
   - Каналы: Стерео

4. На главноем экране в панели "Источники" нажмите "+", из списка добавьте "Захват входного аудиопотока" и "Захват выходного аудиопотока" в обоих случаях выберите устройство по умолчнию.

5. Если нужно добавить фильтр шума, нажмите кнопку "Фильтры", в открывшемся окне нажмите "+" и выберите "Шумоподавление (Noise Suppression)"
